...
cd ${DEQ_DIR}
bash ${DEQ_DIR}/run_trellisnet_experiment.sh train --name mem_sat_3kl --n_layer 3 --pretrain_steps 5000 --seed 500 --timing --time_limit 16000 --batch_size 136 --gpu0_bsz -1
